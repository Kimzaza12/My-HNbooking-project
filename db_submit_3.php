...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $Email = $_POST["Email"];
        ...
        $sql = "SELECT * FROM book_3 WHERE HN = '$hn'";
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<script>window.location.href='summit_3.php'</script>";
        } else {

        // เตรียมคำสั่ง SQL เพื่อเพิ่มข้อมูล
        $sql = "INSERT INTO book_3 (current_datetime, appointment_date, HN, ID_number, S_name, booked_by, Department, P_number, Email)
